...
class WebUINode(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(SynchronizedImage, 'raw_indexed_image', self.listener_callback, qos_profile=qos_profile_system_default) # , qos_profile=qos_profile_sensor_data
        self.subscription
        self.br = CvBridge()
        self.image = None
